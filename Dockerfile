...
# docker run --privileged -v /dev/bus/usb:/dev/bus/usb -v ./ephemeris-v2.rxn:/tmp/ephemeris-v2.rxn -ti gps-sim /usr/local/bin/gps-sim -r uhd -e /tmp/ephemeris-v2.rxn --disable-almanac --verbose -g 50
